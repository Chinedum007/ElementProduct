...
public class AddBooking extends BasePage{
	...
	@FindBy(xpath="//input[@value='70']")
	private WebElement TickEquipmentRequired;
	...
	webActionUtil.selectByTextInListBox(SelectDepartmentFromDropDownList, "Blood Transfusion");
	webActionUtil.selectByTextInListBox(SelectCategoryFromDropDownList, "Audit");
	jse.executeScript("window.scrollBy(0, 300);");
	Thread.sleep(5000);
	webActionUtil.clickOnElement(TickEquipmentRequired);
	jse.executeScript("window.scrollBy(0, -300);");
	Thread.sleep(2000);
